...
public class ExamredetailsController {
                ...
                if (!".xls".equals(suffix)) {
                    ...
                    if (!file.exists()) {
                        ...
                        for (List<String> data : dataList) {
                            ...
                            // examredetailsEntity.setExamquestionId(Integer.valueOf(data.get(0)));
                            // //试题id（外键） 要改的
                            // examredetailsEntity.setExamredetailsMyanswer(data.get(0)); //考生答案 要改的
                            // examredetailsEntity.setExamredetailsMyscore(Integer.valueOf(data.get(0)));
                            // //试题得分 要改的
                        ...
                        // 查询是否重复
                        // 试卷编号
                        List<ExamredetailsEntity> examredetailsEntities_examredetailsUuidNumber = examredetailsService
                                .selectList(new EntityWrapper<ExamredetailsEntity>().in("examredetails_uuid_number",
                                        seachFields.get("examredetailsUuidNumber")));
    ...
    public R saveExamredetails(@RequestBody ExamredetailsEntity examredetails, Integer examrecordId,
